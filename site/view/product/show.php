                    ...
                    <div class="col-md-6">
                        ...
                        <div class="product-detail-carousel-slider">
                            <div class="owl-carousel owl-theme">
                                ...
                                <div class="item thumbnail"><img src="../upload/<?=$imageItem->getName()?>"
                                        alt="<?=$imageItem->getName()?>">
                                </div>
                                <?php endforeach ?>
                            </div>
                        </div>
                        ...
                        <div role="tabpanel">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane" id="product-comment">
                                    <form class="form-comment" action="?c=product&a=addComment" method="POST"
                                        role="form">
                                    ...
                                    <div class="comment-list">
                                        <?php require 'view/product/commentList.php' ?>
                                    </div>
                                </div>
                            </div>
                        </div>
